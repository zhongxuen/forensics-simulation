...
- `case-workspace.spec.ts` — the Evidence Browser on the practice case: open a drive from the keyboard, pin a deleted file, keep the pin across a reload, axe with a drive open.
