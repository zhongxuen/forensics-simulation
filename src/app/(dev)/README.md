...
- `timeline-bench/` — the Timeline view with thousands of made-up moments (`/timeline-bench?entries=5000`), for `tests/e2e/timeline-performance.spec.ts`. Gated by `requireDevPage`.
