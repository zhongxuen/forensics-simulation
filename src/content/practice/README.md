...
The evidence behind the lessons' practice terminals (`docs/plan/13-learning-center.md`: "a `<MiniTerminal>` on the real engine with a tiny generated evidence set, never a fake").
